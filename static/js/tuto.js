...
var data = [
  ...
  {
    'texte': 'Pour poser une question, rien de plus simple ! Cliquer sur "Poser une question" et une interface vous sera proposée. Il suffit de remplir l\'objet de votre question ainsi que le détail afin que la communauté vous aide au mieux. Si vous avez une photo du problème n\'hésitez pas à l\'ajouter en cliquand sur "Fichier".',
    'titre': "3. Poser une question",
    'lien': "/question"
  },
  {
    'texte': "Dans le menu déroulant à droite de votre écran, vous trouverez l'onglet \"Messages privés\". En appuyant sur le \"+\" vous pouvez chercher d'autres utilisateurs afin de débuer une conversation avec eux. Vous pouvez également envoyer des messages vocaux.",
    'titre': "4. Les messages privés",
    'lien': "/messages/60c5ad88186fbabb20bb2a7e/"
  },
  {
    'texte': "Sur votre profil vous pouvez renseigner vos informations comme votre pseudo, vos langues vivantes, votre adresse mail, votre pageéro de téléphone, bien évidemment vous pouvez choisir de les rentre publiques ou non.",
    'titre': "5. Votre Profil",
    'lien': "/profil"
  },
  {
    'texte': "Le système d'XP permet de récomprenser votre contribution sur le site. Il vous permet de débloquer des récompenses uniques en fonction de votre niveau, comme par exemple un large choix de thème pour le site lui même. Vos récompenses ainsi que votre niveau apparaissent sur votre page de profil ",
